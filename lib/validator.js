...
module.exports = {
  ...
  methods: {
    ...
    _watchModel: function (keypath, fn) {
      ...
      this._validatorWatchersCount[keypath] = this._validatorWatchersCount[keypath] || 1
      this._validatorWatchersCount[keypath]++
    },

    _unwatchModel: function (keypath) {
      this._validatorWatchersCount[keypath]--
      if (this._validatorWatchersCount[keypath] === 0) {
